...
parser.add_argument('--mod', type=str, choices=['box_blur', 'gauss_blur', 'bilateral_blur', 'sharpening', 'hist_eq', 'rgb2gray', 'unsharpmask'], default=None, help='the input data modification')
